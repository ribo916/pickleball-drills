# pickleball-drills — project reference

A mobile-first SPA for a small group of pickleball players to manage, browse, and randomly select drills at the court. No auth — 4 friends all have the URL. Live on Vercel.
...
No test suite. Manual browser testing only. Run `npm run dev` and test in the browser.
